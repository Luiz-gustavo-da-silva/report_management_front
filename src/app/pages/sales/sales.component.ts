...
export class SalesComponent {
   displayedColumns: string[] = ['saleId', 'name', 'price', 'quantity', 'totalPrice', 'saleDate', 'action'];
    ...
    deleteSale(id: number) {
      this.salesService.deleteSale(id).subscribe({
        ...
        error: (err) => {
          const errorMessage = err.error?.message || 'Erro ao deletar sale. Por favor, tente novamente!';
